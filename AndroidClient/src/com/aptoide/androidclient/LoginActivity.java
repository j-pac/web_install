...
//				.getSerializableExtra(UserSessionManager.PREF_NAME);
		session_manager = new UserSessionManager(this);
...
//			show_email.setText(session_manager.);
	...
	public void doLogin(View view) {
		...
		String email = (String) findViewById(R.id.email_edit).toString();
		String password = (String) findViewById(R.id.password_edit).toString();
